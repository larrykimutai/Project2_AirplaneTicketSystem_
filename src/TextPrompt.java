...
/***
 *
 * public static void JOptionPaneMultiInput() {
 ...
 *
 *     //int option = JOP...
 *     JOptionPane.showConfirmDialog(null, message, "Customer Information", JOptionPane.OK_CANCEL_OPTION);
 ...
 *     TextPrompt name = new TextPrompt("Enter Name", Name);
 *     JTextField Origin = new JTextField(5);
 *     TextPrompt origin = new TextPrompt("Enter Origin City", Origin);
 *     JTextField Dest = new JTextField(5);
 *     TextPrompt dest = new TextPrompt("Enter Destination City", Dest);
 *     JTextField FNum = new JTextField(5);
 *     TextPrompt fnum = new TextPrompt("Flight Number", FNum);
 *     JTextField Class = new JTextField(5);
 *     TextPrompt _class = new TextPrompt("Enter Origin City", Origin);
 *
